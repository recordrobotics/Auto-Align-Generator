...
namespace AutoAlignGenerator.ui.graphics.ui
{
    public class Image : UIController
    {
        ...
        private PreserveAspectMode preserveAspect = PreserveAspectMode.None;
        public PreserveAspectMode PreserveAspect { get => preserveAspect; set => preserveAspect = value; }
        ...
        private void UVAspect<T>(ref T vertex, PreserveAspectMode uv1, PreserveAspectMode uv2) where T : unmanaged, ITessellatorVertex<T>
        {
        ...
        private void Tessellate<T>(QuadTessellator<T> tessellator) where T : unmanaged, ITessellatorVertex<T>
        {
            switch (imageType)
            {
                case ImageType.Simple:
                    ...
                    if (preserveAspect == PreserveAspectMode.None && !flipHorizontal && !flipVertical)
                    {
                    ...
                    else
                    {
                        ...
                        if (preserveAspect != PreserveAspectMode.None)
                        {
                            UVAspect(ref topLeft, preserveAspect, preserveAspect);
                            UVAspect(ref topRight, preserveAspect, preserveAspect);
                            UVAspect(ref bottomLeft, preserveAspect, preserveAspect);
                            UVAspect(ref bottomRight, preserveAspect, preserveAspect);
                        }
                ...
                case ImageType.Tiled:
                    {
                        ...
                        if (preserveAspect != PreserveAspectMode.None)
                        {
                            UVAspect(ref topLeft, PreserveAspectMode.None, preserveAspect);
                            UVAspect(ref topRight, PreserveAspectMode.None, preserveAspect);
                            UVAspect(ref bottomLeft, PreserveAspectMode.None, preserveAspect);
                            UVAspect(ref bottomRight, PreserveAspectMode.None, preserveAspect);
                        }
